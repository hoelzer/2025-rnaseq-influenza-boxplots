...
output = File.open('/Users/martin/projects/2025-03-13-Influenza-RNASeq-Agustina/TPMs/counts-tpm-segments.tsv','w')
output << ['ID','Name','avian-rep1','avian-rep2','avian-rep3','mock-rep1','mock-rep2','mock-rep3','reass-rep1','reass-rep2','reass-rep3','swine-rep1','swine-rep2','swine-rep3'].join("\t") << "\n"

condition2tsv = {}
gene_ids = []

Dir.glob("/Users/martin/projects/2024-04-16-manual-DESeq-Agustina/2025-04-22-Agustina-segments-TPMs/*.tsv").each do |tsv|
